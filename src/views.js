  ...
  return `<div class="wrap page">
    ...
    <div class="browse-layout">
      <aside class="filter-panel">
        ...
        <div class="fp-block"><h4>排序</h4><div class="segmented" data-seg="browseSort"><button class="${state.browseSort === 'match' ? 'selected' : ''}" data-value="match">匹配度</button><button class="${state.browseSort === 'new' ? 'selected' : ''}" data-value="new">最新入库</button><button class="${state.browseSort === 'price' ? 'selected' : ''}" data-value="price">价格</button><button class="${state.browseSort === 'context' ? 'selected' : ''}" data-value="context">上下文</button></div></div>
      </aside>
